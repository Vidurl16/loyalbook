    ...
    <main className="min-h-screen flex" style={{ background: "var(--background)" }}>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-10 w-full max-w-md">
        ...
        <button
          ...
          className="w-full border border-stone-200 rounded-xl py-3 flex items-center justify-center gap-2 hover:bg-stone-50 transition-colors mb-6 text-stone-700 font-medium"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <input
            ...
            required
            className="w-full border border-stone-200 rounded-xl px-4 py-3 focus:outline-none focus:border-teal-500 bg-stone-50"
          />
          <input
            type="password"
          ...
          <button type="submit" className="w-full bg-teal-700 text-white py-3 rounded-xl hover:bg-teal-800 transition-colors font-medium">
            Sign In
          </button>
        </form>
        ...
        <p className="text-center text-sm text-stone-500 mt-6">
          ...
          <Link href="/signup" className="text-teal-600 hover:underline">Join free</Link>
        </p>
      </div>
      </div>
    </main>
